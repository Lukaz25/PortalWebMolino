...
public interface IUsuarioRepository extends JpaRepository<Usuario,Long> {
    @Query("SELECT u FROM Usuario u WHERE ru.idusuario= :id")
    ...
    Usuario findByNameAndPass(@Param("str") String str1,@Param("str2") String str2);
    ...
    Usuario findByEmailandPass(@Param("str") String str1,@Param("str2") String str2);
